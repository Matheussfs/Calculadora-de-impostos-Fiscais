...
uses U_ICMSTELA, U_Icms_St_Base, U_icms_in;
...
begin
  Try
    Icms_do_st := tIcms_do_st.create(self);
    Icms_do_st.show
  Finally
...
begin
//proteção para não deixar o tedit Edt_icms_total_normal vazio
...
begin
//proteção para não deixar o tedit base icms st vazio
...
begin
//proteção para não deixar o tedit Txt_aliq_icms vazio
if (Txt_aliq_icms.text='') then
begin
showmessage('Deve ser inserido uma alíquota de ICMS-ST');
